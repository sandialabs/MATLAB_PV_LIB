...
%
%% Syntax
% |DNI = pvl_erbs(GHI, Z, doy)|
%
%% Description
% The Erbs model estimates the diffuse fraction (DF) from global 
...
[DNI_model, DHI_model, ~] = pvl_erbs(GHI,90-AppSunEla, dayofyear);
...
xlim([0 25])
legend('DHI (Erbs model)','DHI (TMY3)','Location','NE')
xlabel('Hour of Day')
