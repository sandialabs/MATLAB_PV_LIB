function IAM = pvl_iam_physical(K, L, n, theta)
% PVL_IAM_PHYSICAL Determine the incidence angle modifier using refractive 
...
%
% Description:
%   pvl_iam_physical calculates the incidence angle modifier as described in
